...
export function PacklistTemplatesManagerSheet({ open, onClose }: Props) {
    ...
    <>
      <Sheet open onClose={onClose} title="Packlisten-Vorlagen">
        <p className="text-[13px] mb-3" style={{ color: "var(--ink-soft)" }}>
          Verwalte Vorlagen, die du beim Erstellen einer Packliste anwenden
          kannst — z. B. „Wochenende“, „Wandern“, „Strand“.
        </p>
        ...
        {visible.length === 0 ? (
          <Empty
            ...
            body={"Erstelle deine erste mit dem Button unten."}
          />
        ) : (
